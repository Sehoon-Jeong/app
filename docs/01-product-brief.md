...
SkinCause는 코덕의 화장품 탐색·루틴·사용 결과를 AI가 대화로 기억하고 해석해, 다음 제품 판단부터 7일 관찰, 불편 대응과 다음 추천까지 개인화하는 AI 스킨케어 플랫폼이다.

## 문제

코덕은 만족스러운 제품을 찾고도 탐색을 끝내지 않는다. 새로운 기능, 제형, 유행 제품과 조합을 계속 시도한다. 하지만 무엇을 왜 선택했고 어떤 조건에서 어떤 결과가 있었는지 축적되지 않아 제품 선택과 문제 발생 대응을 매번 후기와 감에 의존한다.
...
SkinCause AI는 사용자의 평소 행동을 막지 않고 네 순간에 개입한다. 모든 흐름은 별도 설문이 아니라 맥락을 이어가는 AI 대화로 연결된다.

1. **제품을 찾을 때**: 원하는 변화를 자연어로 말하면 AI가 필요한 조건만 더 묻고 실제 국내 제품 후보와 근거를 찾는다.
2. **한 제품을 고민할 때**: AI가 현재 루틴, 가진 제품, 과거 기록과 신뢰 가능한 외부 근거를 함께 비교하고 후속 질문에 답한다.
3. **루틴에 넣고 쓴 뒤**: AI가 순서와 빈도를 제안하고, 7일 뒤 실제 사용과 불편 여부를 대화로 확인한다.
4. **불편할 때**: AI가 마지막 안정 루틴 이후 변경과 외부 근거를 살펴보고 확인 순위와 보수적인 다음 루틴을 제안한다.

이 결과는 AI가 기억하는 자연어 맥락과 구조화된 사용 이력으로 함께 쌓여 다음 제품 의견, 추천, 루틴 제안과 Rescue에 다시 사용된다. 사용자는 AI가 기억하는 내용을 언제든 확인하고 고치거나 지울 수 있다.
