...
| F-04 루틴·AI 배치 | RTN | `/me/routines`, `/routine-analyses` | routine_version, routine_item, analysis |
| F-05 7일 결과 | OBS | `/me/routines/current/assessment` | routine_assessment, stable_routine_pointer, notification |
| F-06 AI Rescue | RSC | `/rescues`, `/rescues/{id}/messages`, `/rescues/{id}/apply` | rescue_case, rescue_message, rescue_plan |
| F-07 기록·알림 | HIS, NOT | `/me/routines/history`, `/me/routines/compare`, `/notifications` | routine_version, routine_assessment, notification |
