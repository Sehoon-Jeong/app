...
| `FR-EXP-002` | [#15 한 제품씩 시험하는 사용·관찰 계획 생성](https://github.com/sksksksksksss/service/issues/15) | `createExperimentPlan`, `getCurrentExperiment` | `experiment.user_id`, `status`; SQLite 열린 상태 부분 유일 인덱스 | DB: 사용자당 열린 실험 하나; API: 충돌 응답 |
