...
이 문서는 SkinCause MVP의 **사용자 기능 29개**를 한곳에서 확인하는 기능명세서다. 기능 하나는 GitHub Story 하나와 대응한다.
...
| [FN-PRD-00](./functional-specs/FN-PRD-00.md) | 제품 선택 | P0 | 제품 검색·선택 | 제품명·브랜드로 확인된 제품을 찾아 루틴이나 실험 후보로 선택한다 | [#154](https://github.com/sksksksksksss/service/issues/154) |
| [FN-REC-01](./functional-specs/FN-REC-01.md) | 제품 선택 | P0 | 개인화 제품 추천 | 안정 루틴과 목적을 기준으로 다음 실험 후보와 하나의 우선순위를 받는다 | [#8](https://github.com/sksksksksksss/service/issues/8) |
...
| [FN-LAB-01](./functional-specs/FN-LAB-01.md) | LAB 성장 | P0 | 실험 완료와 관찰 완성도 | 실험 완료 상태와 실제로 남긴 필수 관찰의 완성도를 구분해 확인한다 | [#19](https://github.com/sksksksksksss/service/issues/19) |
...
| [FN-RSC-03](./functional-specs/FN-RSC-03.md) | Rescue | P0 | 변경 사실과 확인 순서 | 제품별 변경 사실과 안전 경계를 분리해 확인한다 | [#24](https://github.com/sksksksksksss/service/issues/24) |
| [FN-ARC-01](./functional-specs/FN-ARC-01.md) | Beauty Archive | P0 | 세 결과 저장·루틴 갱신 | 불편·목적 체감·다음 결정을 남기고 원할 때만 안정 루틴을 갱신한다 | [#25](https://github.com/sksksksksksss/service/issues/25) |
...
| [FN-PER-02](./functional-specs/FN-PER-02.md) | Beauty Archive | P1 | 개인 반복 관찰 | 반복 경험과 반대 사례를 기록 완성도·횟수·원본과 함께 확인한다 | [#27](https://github.com/sksksksksksss/service/issues/27) |
